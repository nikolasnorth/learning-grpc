...
type CalculatorClient interface {
	Add(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error)
	Sub(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error)
	Mult(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error)
	Div(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*FloatResponse, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error) {
	out := new(IntResponse)
...
func (c *calculatorClient) Sub(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error) {
	out := new(IntResponse)
...
func (c *calculatorClient) Mult(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntResponse, error) {
	out := new(IntResponse)
...
func (c *calculatorClient) Div(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*FloatResponse, error) {
...
type CalculatorServer interface {
	Add(context.Context, *IntRequest) (*IntResponse, error)
	Sub(context.Context, *IntRequest) (*IntResponse, error)
	Mult(context.Context, *IntRequest) (*IntResponse, error)
	Div(context.Context, *IntRequest) (*FloatResponse, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *IntRequest) (*IntResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedCalculatorServer) Sub(context.Context, *IntRequest) (*IntResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sub not implemented")
}
func (UnimplementedCalculatorServer) Mult(context.Context, *IntRequest) (*IntResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Mult not implemented")
}
func (UnimplementedCalculatorServer) Div(context.Context, *IntRequest) (*FloatResponse, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*IntRequest))
	}
...
func _Calculator_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Sub(ctx, req.(*IntRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Mult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Mult(ctx, req.(*IntRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Div_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Div(ctx, req.(*IntRequest))
	}
	return interceptor(ctx, in, info, handler)
}
